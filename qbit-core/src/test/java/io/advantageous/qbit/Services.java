...
public class Services {
    ...
    public static Service jsonService(final String name, Object service, int waitTime, TimeUnit timeUnit, int batchSize) {
        ...
        ServiceImpl serviceQueue = new ServiceImpl(null, name, service, waitTime, timeUnit, batchSize, new BoonServiceMethodCallHandler(), null);
    ...
    public static Service regularService(final String name, Object service, int waitTime, TimeUnit timeUnit, int batchSize) {
        return new ServiceImpl(null, name, service, waitTime, timeUnit, batchSize, new BoonServiceMethodCallHandler(), null);
    }
}
