...
public class ServerTest extends TimedTesting {
    ...
    public void testServer() {
        ...
        EndpointServerImpl server = new EndpointServerImpl(httpServer, encoder, parser, serviceBundle, mapper, 30, 100, 30, 10, null);
    ...
    public void testServerTimeout() {
        ...
        EndpointServerImpl server = new EndpointServerImpl(httpServer, encoder, QBit.factory().createProtocolParser(), serviceBundle, mapper, 1, 100, 30, 10, null);
