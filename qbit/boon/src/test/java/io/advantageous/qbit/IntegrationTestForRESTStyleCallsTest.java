...
public class IntegrationTestForRESTStyleCallsTest {
    ...
    public void testBasicCrud() {
        ...
        Assert.assertEquals(1000, employee1.level);
        Assert.assertEquals(rick.active, employee1.active);
    ...
    public void testTwoUriPathVars() {
        ...
        Assert.assertEquals(rick.id, employee1.id);
        Assert.assertEquals(100, employee1.level);
    ...
    public void testAsync() {
        ...
        Assert.assertEquals("hi mom", response.body());
