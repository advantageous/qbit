...
public class ServiceEndpointServerImplTest extends TimedTesting {
    ...
    public void setup() {
        ...
        serviceServerImpl = new ServiceEndpointServerImpl(httpServer, encoder, protocolParser, serviceBundle, mapper, 1, 100, 30, 10, null, "", null, 8080, 0, null, null);
    ...
    public void testWithServiceQueue() {
        ...
        serviceServerImpl = new ServiceEndpointServerImpl(httpServer, encoder, protocolParser, serviceBundle,
                mapper, 1, 100, 30, 10, null, null, null, 8080, 0, null, null);
