...
public class CorsService {
        ...
        public void checkCors(final HttpRequest request, final HttpResponse response)
                throws IOException {
            ...
            switch (requestType) {
                case SIMPLE:
                    ...
                    this.handleSimpleCORS(request, response);
                    break;
                case ACTUAL:
                ...
                default:
                    ...
                    this.handleInvalidCORS(request, response);
                    break;
            }
        }
         ...
         *
         */
        protected void handleSimpleCORS(final HttpRequest request,
         ...
         */
        protected void handlePreflightCORS(final HttpRequest request,
                                           final HttpResponse response)
                throws IOException {
         ...
         * Handles a CORS request that violates specification.
         */
        private void handleInvalidCORS(final HttpRequest request,
                                       final HttpResponse response) {
